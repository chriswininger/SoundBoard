...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { default_image: @clip.default_image, info: @clip.info, playing_image: @clip.playing_image, title: @clip.title }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { default_image: @clip.default_image, info: @clip.info, playing_image: @clip.playing_image, title: @clip.title }
    assert_redirected_to clip_path(assigns(:clip))
  end
